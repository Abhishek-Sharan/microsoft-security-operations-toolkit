...
$resourceGroupName = Read-Host -Prompt "This script installs AMA extension on Linux VMs in a specific resource group; specify your resource group name to continue"
